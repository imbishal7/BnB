...
class ListingCreate(BaseModel):
    ...
    price: float
    quantity: int
    condition: str = "NEW"  # Item condition: NEW, USED, REFURBISHED
    
    # eBay additional fields
...
class ListingUpdate(BaseModel):
    ...
    condition: Optional[str] = None  # Item condition: NEW, USED, REFURBISHED
...
class ListingResponse(BaseModel):
    ...
    enriched_sku: Optional[str] = None  # SKU generated by n8n
    ebay_aspects: Optional[dict] = None  # eBay product aspects from n8n
    status: str
